...
typedef int v8hi __attribute__ ((vector_size (32)));

static void md5_cpu_avx2(v8hi *interleaved8_data, v8hi *interleaved8_hash)
{ // eight interleaved messages -> eight interleaved MD5 hashes
  v8hi a, b, c, d, interleaved8_state[4], interleaved8_x[16];
# define C(c) (v8hi){(int)(c), (int)(c), (int)(c), (int)(c), (int)(c), (int)(c), (int)(c), (int)(c)}
...
# define N_TIMING_TESTS  1000000u
  ...
  for (n = 0u; n < N_MESSAGES; n += 8u)
  {
    ...
    // compute MD5 hashes
    //
    md5_cpu_avx2((v8hi *)interleaved_test_data, (v8hi *)interleaved_test_hash);
    //
